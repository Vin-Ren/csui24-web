...
const Card = ({ entry }: { entry: FamsDataType }) => {
  ...
  return (
    <div
      className="col-span-1 p-6 pt-9 w-[185px] h-[237px] bg-[#292929] bg-repeat-round rounded-[14px] flex flex-col items-center gap-5 justify-evenly"
      key={entry.id}
    >
      <Image
      ...
      <div className="flex flex-row items-center justify-center">
        <p className="flex-1 text-white text-center font-sfPro">
          {displayed_name}
        </p>
      </div>
    </div>
...
const page = () => {
  return (
    <div className="h-fit w-full bg-black">
      <div className="flex flex-col h-fit w-full pt-72 px-8 items-center">
        <h1 className="text-6xl text-white font-sfPro">
